...
For each month (September, October, November, and December), strictly follow this structure and include each and every heading:
...
VERY IMPORTANT: Make sure every college follows the same template structure.
...
# def format_content_with_page_breaks(doc, content):
#     lines = content.splitlines()
#     collecting_content = False  # Start collecting after certain headings
#     current_heading = None
...
#             heading_text = get_heading_text(line)
#             if is_month_heading(heading_text):
#                 # Always add a page break before a new month heading
#                 if current_heading:
#                     doc.add_page_break()
#                 doc.add_heading(heading_text, level=1)
#                 current_heading = heading_text
...
#             elif is_talking_points(heading_text):
#                 # Add "Talking Points" without a page break
#                 doc.add_heading(heading_text, level=1)
#                 current_heading = heading_text
#                 collecting_content = True

#             elif is_social_media_topic_ideas(heading_text) or is_text_messaging_talking_points(heading_text):
#                 # Add a page break before "Social Media Topic Ideas" or "Text Messaging Talking Points"
#                 doc.add_page_break()
#                 doc.add_heading(heading_text, level=1)
#                 current_heading = heading_text
#                 collecting_content = True
...
#             else:
#                 # Add a page break before any other heading
#                 doc.add_page_break()
#                 doc.add_heading(heading_text, level=1)
#                 current_heading = heading_text
#                 collecting_content = True
...
#         else:
#             # Add regular paragraphs only after starting collection
#             if collecting_content:
#                 doc.add_paragraph(line)
